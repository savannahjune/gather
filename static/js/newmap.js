...
function displayPlaceInfo(placeID) {
    ...
    service.getDetails(request, function(response, status) {
        ...
        // else {
            ...
            $(".share_links").html("<a href=\"comgooglemaps://?saddr=Google+Inc,+8th+Avenue,+New+York,+NY&daddr=John+F.+Kennedy+International+Airport,+Van+Wyck+Expressway,+Jamaica,+New+York&directionsmode=transit\">Fake Link</a>");
